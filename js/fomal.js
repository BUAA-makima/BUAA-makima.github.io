...
function createtime1() {
  var grt = new Date("04/11/2023 00:00:00"); //此处修改你的建站时间或者网站上线时间
 ...
 ____    ____       _       ___  ____   _____  ____    ____       _     _______  _______  _______  
|_   \  /   _|     / \     |_  ||_  _| |_   _||_   \  /   _|     / \   |  ___  ||  ___  ||  ___  | 
  |   \/   |      / _ \      | |_/ /     | |    |   \/   |      / _ \  |_/  / / |_/  / / |_/  / /  
  | |\  /| |     / ___ \     |  __'.     | |    | |\  /| |     / ___ \     / /      / /      / /   
 _| |_\/_| |_  _/ /   \ \_  _| |  \ \_  _| |_  _| |_\/_| |_  _/ /   \ \_  / /      / /      / /    
|_____||_____||____| |____||____||____||_____||_____||_____||____| |____|/_/      /_/      /_/     
...
function createtime2() {
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by Makima777 %c 你正在访问Makima777のBlog",
...
function share_() {
  ...
  try {
    ...
    var subTitle = title.endsWith("| Makima777") ? title.substring(0, title.length - 14) : title;
    navigator.clipboard.writeText('Makima777的站内分享\n标题：' + subTitle + '\n链接：' + url + '\n欢迎来访！🍭🍭🍭');
    new Vue({
      data: function () {
        this.$notify({
          title: "成功复制分享信息🎉",
...
function createtime() {
  ...
  var start = new Date("04/11/2023 00:00:00"); // 旅行者1号开始计算的时间
  var dis = Math.trunc(23400000000 + ((now - start) / 1000) * 17); // 距离=秒数*速度 记住转换毫秒
  var unit = (dis / 149600000).toFixed(6);  // 天文单位
  // 网站诞生时间
  var grt = new Date("04/11/2023 00:00:00");
  ...
  (currentTimeHtml =
    hnum < 22 && hnum >= 8
      ? `<img class='boardsign' src='https://img.shields.io/badge/makima-study-6adea8?style=social&logo=cakephp' title='再不学习就该吃土了'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`
      : `<img class='boardsign' src='https://img.shields.io/badge/makima-sleep-6adea8?style=social&logo=coffeescript' title='再不睡觉头发就没了'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`),
